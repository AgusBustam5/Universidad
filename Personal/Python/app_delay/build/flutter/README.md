...
* `app_delay` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `app_delay` - executable or bundle name on disk.
* `app_delay` - display name shown in window titles and about app dialogs.
